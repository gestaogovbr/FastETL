...
FROM
	...
	LEFT JOIN PGG_DW.DW_APF_GERAL.DM_ORGAO_UNIFICADO OU
		ON FT.ORGAO_UNIFICADO_ID = OU.ORGAO_UNIFICADO_ID
	LEFT JOIN PGG_DW.DW_APF_GERAL.DM_ORG_PADRONIZADO OP
	...
	LEFT JOIN PGG_DW.DW_APF_GERAL.DM_ORGAO_NATUREZA_JURIDICA NJ
		ON OP.ORG_PADR_ID_NATUREZA_JURIDICA = NJ.ORGAO_NATUREZA_JURIDICA_ID
	LEFT JOIN PGG_DW.DW_APF_GERAL.DM_ORGAO_CLASSIFICACAO C
