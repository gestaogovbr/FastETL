WITH tbl_tempo_dia_id AS (
	...
	WHERE INFORMACAO_TIPO_ID IN ({{ params.informacao_tipo_id }})
...
SELECT
	...
	, FT_INFORMACOES_SIAPE_DT_INCLUSAO
FROM PGG_DW.DW_APF_FATOS.FT_INFORMACOES_SIAPE
WHERE INFORMACAO_TIPO_ID IN ({{ params.informacao_tipo_id }}) AND TEMPO_DIA_ID IN (SELECT TEMPO_DIA_ID FROM tbl_tempo_dia_id)
