...
def save_load_info(
    ...
    Args:
        source_conn_id (str): _description_
        source_schema_table (str): _description_
        load_type (str): _description_
        dest_conn_id (str): _description_
        log_schema_name (str): _description_
        rows_loaded (int): _description_
    """
    load_info = LoadInfo(
